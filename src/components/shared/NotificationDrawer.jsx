      ...
      {showNotifications && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-24 right-6 w-[320px] bg-white border border-[#F0F0F8] rounded-[28px] shadow-[0_20px_60px_rgba(124,111,247,0.12)] z-[101] p-5 overflow-hidden"
          >
            <div className="flex items-center justify-between mb-5">
              ...
              <button 
                onClick={toggleNotifications}
                className="w-8 h-8 rounded-full flex items-center justify-center bg-[#F8F7FF] text-[#94A3B8]"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <button 
              onClick={toggleNotifications}
              className="mt-6 w-full py-3 bg-[#F8F7FF] rounded-xl text-[12px] font-[800] text-[#94A3B8] uppercase tracking-widest hover:bg-[#EEF2FF] transition-colors"
              style={S}
            >
              Clear All
            </button>
