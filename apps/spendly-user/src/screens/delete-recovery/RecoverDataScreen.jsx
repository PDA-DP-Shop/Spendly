    ...
    <div className="min-h-dvh bg-white flex flex-col safe-top safe-bottom">
      ...
      <div className="flex-1 px-8 pt-4 overflow-y-auto scrollbar-hide">
        <motion.div
           ...
           animate={{ y: 0 }}
        >
          <h1 className="text-[32px] font-[900] text-black tracking-tighter leading-[1.1] mb-4" style={S}>
            Found your <br/><span className="text-emerald-500">deleted record.</span>
          </h1>
          
          <p className="text-[#AFAFAF] text-[15px] font-[600] leading-relaxed mb-10" style={S}>
          ...
          <div className="space-y-4 mb-10">
            <div className="p-6 rounded-[32px] bg-[#F6F6F6] border border-[#EEEEEE] flex items-center gap-5">
              ...
              <div className="flex-1">
                <p className="text-[18px] font-[802] text-black" style={S}>{vault.totalExpenses + vault.totalIncome} Records</p>
                <p className="text-[12px] font-[700] text-[#AFAFAF] uppercase tracking-wider" style={S}>Full Transaction History</p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-[32px] bg-[#F6F6F6] border border-[#EEEEEE] flex items-center gap-5">
              ...
              <div className="flex-1">
                <p className="text-[18px] font-[802] text-black" style={S}>{vault.totalScans} Bill Scans</p>
                <p className="text-[12px] font-[700] text-[#AFAFAF] uppercase tracking-wider" style={S}>Receipt & Photo Cache</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-[11px] font-[802] text-emerald-600 uppercase tracking-[0.2em] mb-3" style={S}>Vault Availability</p>
            <div className="flex items-center gap-3 text-emerald-950 text-[20px] font-[900]">
              <Clock className="w-5 h-5" strokeWidth={3} /> {remaining}
            </div>
            <p className="text-[11px] font-[700] text-emerald-700/50 mt-4 text-center leading-relaxed" style={S}>
              After this window, data will be permanently <br/>erased from the device.
            </p>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="p-8 pb-12 flex flex-col gap-4 bg-white sticky bottom-0">
        ...
        <motion.button
          whileTap={{ scale: 0.98 }}
          onClick={() => navigate(-1)}
          className="w-full py-5 rounded-[24px] bg-[#F6F6F6] text-[#545454] font-[802] text-[15px]"
          style={S}
        >
          Maybe Later
        </motion.button>
