  ...
  if (isStopped) {
    return (
      <div className="fixed inset-0 z-[110] bg-white flex flex-col items-center justify-center p-8 text-center safe-top safe-bottom">
        ...
        <h2 className="text-[34px] font-[900] text-black tracking-tighter mb-4" style={S}>Your data <br/>is safe!</h2>
        <p className="text-[#AFAFAF] text-[17px] font-[600] mb-12 leading-relaxed" style={S}>Nothing has been removed. <br/>You can continue using the app.</p>
        <motion.button 
          whileTap={{ scale: 0.98 }}
  ...
  return (
    <div className="min-h-dvh bg-white flex flex-col safe-top safe-bottom">
      <div className="flex-1 flex flex-col items-center text-center pt-20 px-8">
        ...
        <h2 className="text-[14px] font-[802] text-red-500 uppercase tracking-[0.3em] mb-12" style={S}>Permanent Wipe in...</h2>
        
        <div className="relative w-56 h-56 flex items-center justify-center mb-16">
          <svg className="absolute inset-0 w-full h-full -rotate-90">
            <motion.circle 
              cx="112" cy="112" r="100" 
              fill="none" stroke="#F6F6F6" strokeWidth="12" 
            />
            <motion.circle 
              cx="112" cy="112" r="100" 
        ...
        <p className="text-[#AFAFAF] text-[15px] font-[700] max-w-[200px] leading-relaxed" style={S}>
          Final check: Everything will be moved to the vault.
        </p>
      </div>
      ...
      >
        <motion.div 
          ...
          whileTap={{ x: '0%' }}
        />
        <XCircle className="w-8 h-8" strokeWidth={3} /> <span style={S}>STOP — Keep Data</span>
      </motion.button>
    </div>
  );
};
